			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(../assets/media/illustrations/sketchy-1/14-dark.png)">
				...
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					...
					<div class="w-lg-600px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						<!--begin::Form-->
						<form  action="<?= base_url('register/process') ?>" class="form w-100" novalidate="novalidate" id="kt_sign_up_form"method="post">
						<?= csrf_field(); ?>
							<!--begin::Heading-->
							...
							<div class="fv-row mb-7">
								...
								<input class="form-control form-control-lg form-control-solid" type="email" placeholder="" name="CORREO_ELECTRONICO" autocomplete="off" />
							</div>
							<!--end::Input group-->
							<!--begin::Input group-->
