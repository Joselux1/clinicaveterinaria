...
<html lang="es">
	...
	<head><base href="../">
		...
		<link rel="shortcut icon" href="../assets/media/logos/icons8-favicon-48.png" />		<!--begin::Fonts-->
                                        ...
                                        <div class="card mb-5 mb-xl-8">
											...
											<div class="card-body">
                                                    ...
                                                    <div class="d-flex flex-center flex-column py-5">
                                                        <!--begin::Editar-->
                                                        <form action="<?= isset($evento) ? base_url('eventos/actualizar/' . $evento['PK_ID_EVENT']) : base_url('eventos/guardar') ?>" method="POST">
                                                            <?= csrf_field(); ?>							
                                                            
                                                          
                                                            <div class="mb-3">
                                                                <label for="TITULO" class="form-label">Título</label>  <!-- Título del evento -->
                                                                <input type="text" name="TITULO" id="TITULO" class="form-control" 
                                                                    value="<?= isset($evento) ? esc($evento['TITULO']) : '' ?>" required>
                                                            </div>
                                                            ...
                                                            <div class="mb-3">
                                                                    ...
                                                                    value="<?= isset($evento) ? esc($evento['FECHA_INICIO']) : '' ?>" required>
                                                            </div>
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="datetime-local" name="FECHA_FIN" id="FECHA_FIN" class="form-control" 
                                                                    value="<?= isset($evento) ? esc($evento['FECHA_FIN']) : '' ?>">
                                                            </div>
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="DESCRIPCION_ENG" class="form-label">Descripción (Inglés)</label>
                                                                <textarea name="DESCRIPTION_ENG" id="DESCRIPCION_ENG" class="form-control"><?= isset($evento) ? esc($evento['DESCRIPCION_ENG']) : '' ?></textarea>
                                                            </div>

                                                            <!-- Botones -->
                                                            <button type="submit" class="btn btn-success"><?= isset($evento) ? 'Actualizar' : 'Guardar' ?></button>
