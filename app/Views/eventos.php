						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
							...
							<div class="menu-item">
								<div class="menu-content pb-2">
									<span class="menu-section text-muted text-uppercase fs-8 ls-1">Panel de
										Control</span>
								</div>
							</div>
								...
								<div class="menu-sub menu-sub-accordion">
									<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion mb-1">
										...
										<div class="menu-sub menu-sub-accordion">
											<div class="menu-item">
												<a class="menu-link"
													href="http://localhost/clinicaveterinaria/public/clientes">
											...
											<div class="menu-item">
												<a class="menu-link"
													href="http://localhost/clinicaveterinaria/public/mascotas">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
											...
											<div class="menu-item">
												<a class="menu-link"
													href="http://localhost/clinicaveterinaria/public/medicamentos">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
											...
											<div class="menu-item">
												<a class="menu-link"
													href="http://localhost/clinicaveterinaria/public/citas">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
										...
										<div class="modal-dialog modal-dialog-centered mw-650px">
											...
											<div class="modal-content">
												...
												<div class="modal-header">
													<h2 class="fw-bolder" data-kt-calendar="title">Añadir Eventos</h2>
												...
												<div class="modal-body py-10 px-lg-17" id="eventoModal">
													<form id="eventoForm" action="<?= isset($evento) ? base_url('eventos/actualizar/' . $evento['PK_ID_EVENT']) : base_url('eventos/guardar') ?>" method="POST">
														...
														<div class="fv-row mb-9">
															<label for="TITULO" class="fs-6 fw-bold required mb-2">Nombre Evento</label>
															<input type="text" name="TITULO" id="TITULO" class="form-control" placeholder="Nombre Evento" value="<?= isset($evento) ? esc($evento['TITULO']) : '' ?>" required> 
														</div>

														<div class="fv-row mb-9">
															<label for="DESCRIPCION_ES" class="fs-6 fw-bold mb-2 required">Descripción del Evento</label>
														...
														<div class="row row-cols-lg-2 g-10">
															...
															<div class="col">
																<div class="fv-row mb-9">
																	<label class="fs-6 fw-bold mb-2 required ">Fecha de Fin</label>
																	<input type="datetime-local" name="FECHA_FIN" id="FECHA_FIN" class="form-control" value="<?= isset($evento) ? esc($evento['FECHA_FIN']) : '' ?>">
																</div>
															</div>
														</div>
													</form>
												...
												<div class="modal-footer flex-center">
													<button type="button" id="kt_modal_add_event_cancel" class="btn btn-light me-3" data-bs-dismiss="modal">
														Cancelar
													</button>

													<button type="submit" form="eventoForm" id="kt_modal_add_event_submit" class="btn btn-primary">
										...
										<div class="modal-dialog modal-dialog-centered mw-650px">
											...
											<div class="modal-content">
												...
												<div class="modal-header border-0 justify-content-end">
													<!--begin::Edit-->
													<div class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-primary me-2" data-bs-toggle="tooltip" data-bs-dismiss="click" title="Edit Event" id="TITULO">
												...
												<div class="modal-body pt-0 pb-20 px-lg-17">
													...
													<div class="d-flex align-items-center mb-2">
														...
														<div class="fs-6">
															<span class="fw-bolder">Fecha  Inicio</span>
													...
													<div class="d-flex align-items-center mb-9">
														...
														<div class="fs-6">
															<span class="fw-bolder">Fecha Fin</span>
