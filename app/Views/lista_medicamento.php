									...
									<div class="card-header border-0 pt-6">
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
												...
												<!--end::Filter-->
												<!--begin::Export-->
												<a href="<?php echo base_url('medicamentos/exportarCSV'); ?>"><button type="button" class="btn btn-light-primary me-3" data-bs-target="#kt_modal_export_users">
											...
											<tbody class="text-gray-600 fw-bold">
												<?php if (!empty($medicamentos) && is_array($medicamentos)): ?>
													<?php foreach ($medicamentos as $medicamento): ?>
														<tr class="<?= $medicamento['FECHA_BAJA'] ? 'table-danger' : '' ?>">
															...
															<td class="text-end">
																...
																<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
																	...
																	<!-- Mostrar "Eliminar" solo si el medicamento NO está dado de baja -->
																	<?php if (!$medicamento['FECHA_BAJA']): ?>
																	<div class="menu-item px-3">
																	...
																	<!-- Mostrar "Dar de Alta" solo si el medicamento está dado de baja -->
																	<?php if ($medicamento['FECHA_BAJA']): ?>
																	<div class="menu-item px-3">
																		<form action="<?= base_url('medicamentos/reactivar/' . $medicamento['PK_ID_MEDICAMENTO']) ?>" method="post" style="display:inline;">
																			<?= csrf_field() ?>
