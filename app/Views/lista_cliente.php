...
<html lang="en">
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="header-fixed-top header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px"><br><br><br>
							<!--begin::Content-->
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Lista Cliente</h1>
									<!--end::Title-->
									<!--begin::Separator-->
												...
												<div class="modal-dialog modal-dialog-centered mw-650px">
													...
													<div class="modal-content">
														...
														<!--begin::Modal body-->
																<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
																	<!--begin::Form-->
																	<form action="<?= base_url('agregar_usuario') ?>" method="post" id="kt_modal_add_user_form" class="form">
																	<?= csrf_field(); ?>
																	<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
																		<!--begin::Input group-->
																		<div class="fv-row mb-7">
																			<label class="required fw-bold fs-6 mb-2">Nombre</label>
																			<input type="text" id="NOMBRE" name="NOMBRE" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Nombre" required />
																		</div>
																		<!--end::Input group-->
																		...
																		<div class="fv-row mb-7">
																			...
																			<input type="email" id="CORREO_ELECTRONICO" name="CORREO_ELECTRONICO" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Correo Electrónico" required />
																		</div>
																		<div class="fv-row mb-7">
																			<label class="required fw-bold fs-6 mb-2">Contraseña</label>
																			<input type="password" id="CONTRASEÑA" name="CONTRASEÑA" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Contraseña" required />
																		</div>
																	...
																	<div class="text-center pt-15">
																		...
																		<button type="submit" class="btn btn-primary" data-kt-users-modal-action="submit">
																			<span class="indicator-label">Añadir</span>
															...
															<td class="text-end">
																	...
																	<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
																		...
																		<div class="menu-item px-3">
																			<a href="<?= base_url('clientes/editar/' . $cliente['PK_ID_CLIENTE']) ?>" class="btn btn-warning btn-sm w-100">Editar</a>
																		</div>
																		<!--end::Menu item-->
																		<!--begin::Menu item-->
																		<div class="menu-item px-3">
																			<a href="<?= base_url('clientes/eliminar/') . esc($cliente['PK_ID_CLIENTE']) ?>" class="btn btn-danger btn-sm w-100" onclick="return confirm('¿Estás seguro de eliminar este cliente?');">Eliminar</a>
																		</div>
																		<!--end::Menu item-->
																	</div>
															</td>
					...
					<div class="aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active" href="http://localhost/clinicaveterinaria/public/clientes">
								...
								<div class="menu-item">
									<a class="menu-link" href="http://localhost/clinicaveterinaria/public/veterinarios">
										<span class="menu-icon">
								...
								<div class="menu-item">
									<div class="menu-content pt-8 pb-2">
										<span class="menu-section text-muted text-uppercase fs-8 ls-1">Listas</span>
									</div>
								</div>
								...
								<span class="menu-link">
										...
										<span class="menu-title">Despegable Listas</span>
