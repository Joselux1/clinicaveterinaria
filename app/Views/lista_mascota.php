							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack ">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<!--begin::Item-->
										<li class="breadcrumb-item text-muted">
										<a href="http://localhost/clinicaveterinaria/public/mascotas" class="text-muted text-hover-primary">Mascotas</a>
										</li>
										<!--end::Item-->
										<!--begin::Item-->
									...
									<div class="card-header border-0 pt-6">
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
												...
												<!--end::Filter-->
												<!--begin::Export-->
												<a href="<?php echo base_url('mascotas/exportarCSV'); ?>"><button type="button" class="btn btn-light-primary me-3" data-bs-target="#kt_modal_export_users">
												...
												<!--end::Export-->
												<!--begin::Add user-->
												<a href="<?= base_url(relativePath: 'mascotas/crear') ?>"><button type="button" class="btn btn-light-primary me-3"">
											...
											<tbody class="text-gray-600 fw-bold">
												<?php if (!empty($mascotas) && is_array($mascotas)): ?>
													<?php foreach ($mascotas as $mascota): ?>
														<tr class="<?= $mascota['FECHA_BAJA'] ? 'table-danger' : '' ?>">
															...
															<td class="text-end">
																...
																<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
																	...
																	<!-- Mostrar "Eliminar" solo si la mascota NO está dada de baja -->
																	<?php if (!$mascota['FECHA_BAJA']): ?>
																	<div class="menu-item px-3">
																		<a href="<?= base_url('mascotas/eliminar/') . esc($mascota['PK_ID_MASCOTA']) ?>" class="btn btn-danger btn-sm w-100" onclick="return confirm('¿Estás seguro de eliminar esta mascota?');">Eliminar</a>
																	</div>
																	<?php endif; ?>

																	<!-- Mostrar "Dar de Alta" solo si la mascota está dada de baja -->
																	<?php if ($mascota['FECHA_BAJA']): ?>
																	<div class="menu-item px-3">
																		<form action="<?= base_url('mascotas/reactivar/' . $mascota['PK_ID_MASCOTA']) ?>" method="post" style="display:inline;">
																			<?= csrf_field() ?>
