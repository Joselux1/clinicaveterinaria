										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
											...
											<thead>
												<tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                                    ...
                                                    <th class="min-w-125px">Diagnostico</th>
                                                    <nto class="min-w-125px">Tratamiento</th>
                                                    <th class="min-w-125px">Fecha Baja</th>
														...
														<tr>
															...
															<td class="text-end">
																	...
																	<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
																		...
																		<!--begin::Menu item-->
																		<div class="menu-item px-3">
																			<a href="<?= base_url('citas/eliminar') . esc($cita['PK_ID_CITA']) ?>" class="btn btn-danger btn-sm w-100" onclick="return confirm('¿Estás seguro de eliminar esta Cita?');">Eliminar</a>
																		</div>
																		<!--end::Menu item-->
																	</div>
															</td>
