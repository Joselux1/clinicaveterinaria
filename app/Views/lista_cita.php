...
<html lang="es">
	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
		...
		<div class="d-flex flex-column flex-root">
			<!--begin::Page-->
			<div class="page d-flex flex-row flex-column-fluid  align-items: flex-start;">
				<!--begin::Aside-->
					...
					<div class="aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion mb-1">
									...
									<div class="menu-sub menu-sub-accordion">
										<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion mb-1">
											...
											<div class="menu-sub menu-sub-accordion">
											<div class="menu-item">
													<a class="menu-link" href="http://localhost/clinicaveterinaria/public/clientes">
								...
								<div class="menu-item">
								<a class="menu-link active" href="http://localhost/clinicaveterinaria/public/eventos">
									<span class="menu-icon">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack ">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<!--begin::Item-->
										<li class="breadcrumb-item text-muted">
										<a href="http://localhost/clinicaveterinaria/public/citas" class="text-muted text-hover-primary">Citas</a>
										</li>
										<!--end::Item-->
								...
								<div class="card">
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
												...
												<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
													<!--begin::Header-->
													<div class="px-7 py-5">
														<div class="fs-5 text-dark fw-bolder">Opciones de Filtros</div>
													</div>
													<!--end::Header-->
													<!--begin::Separator-->
													...
													<div class="px-7 py-5" data-kt-user-table-filter="form">
														<div class="mb-10">
														<input type="text" name="FECHA" class="form-control" placeholder="Buscar por Fecha" value="<?= isset($fecha) ? esc($fecha) : '' ?>">
														</div>
														
														<div class="mb-10">
														<input type="text" name="DIAGNOSTICO" class="form-control" placeholder="Buscar por Diagnóstico" value="<?= esc($diagnostico ?? '') ?>">
														</div>
												...
												<!--end::Filter-->
												<!--begin::Export-->
												<a href="<?php echo base_url('citas/exportar'); ?>"><button type="button" class="btn btn-light-primary me-3" data-bs-target="#kt_modal_export_users">
													<!--begin::Svg Icon | path: icons/duotune/arrows/arr078.svg-->
													<span class="svg-icon svg-icon-2">
														<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
															<rect opacity="0.3" x="12.75" y="4.25" width="12" height="2" rx="1"
																transform="rotate(90 12.75 4.25)" fill="black"/>
															<path d="M12.0573 6.11875L13.5203 7.87435C13.9121 8.34457 14.6232 8.37683 
																	15.056 7.94401C15.4457 7.5543 15.4641 6.92836 15.0979 6.51643L12.4974 
																	3.59084C12.0996 3.14332 11.4004 3.14332 11.0026 3.59084L8.40206 6.51643C8.0359 
																	6.92836 8.0543 7.5543 8.44401 7.94401C8.87683 8.37683 9.58785 8.34458 
																	9.9797 7.87435L11.4427 6.11875C11.6026 5.92684 11.8974 5.92684 12.0573 6.11875Z"
																fill="black"/>
															<path d="M18.75 8.25H17.75C17.1977 8.25 16.75 8.69772 16.75 9.25C16.75 9.80228 17.1977 
																	10.25 17.75 10.25C18.3023 10.25 18.75 10.6977 18.75 11.25V18.25C18.75 18.8023 
																	18.3023 19.25 17.75 19.25H5.75C5.19772 19.25 4.75 18.8023 4.75 18.25V11.25C4.75 
																	10.6977 5.19771 10.25 5.75 10.25C6.30229 10.25 6.75 9.80228 6.75 9.25C6.75 8.69772 
																	6.30229 8.25 5.75 8.25H4.75C3.64543 8.25 2.75 9.14543 2.75 10.25V19.25C2.75 20.3546 
																	3.64543 21.25 4.75 21.25H18.75C19.8546 21.25 20.75 20.3546 20.75 19.25V10.25C20.75 
																	9.14543 19.8546 8.25 18.75 8.25Z"
																fill="#C4C4C4"/>
														</svg>
													</span>
									...
									<div class="card-body pt-0">
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
											...
											<tbody class="text-gray-600 fw-bold">
												<?php if (!empty($citas) && is_array($citas)): ?>
													<?php foreach ($citas as $cita): ?>
														<tr class="<?= $cita['FECHA_BAJA'] ? 'table-danger' : '' ?>">
															...
															<td class="text-end">
																<a href="#" class="btn btn-light btn-active-light-primary btn-sm"
																	...
																	data-kt-menu-placement="bottom-end">Modificar
																...
																<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
																	<div class="menu-item px-3">
																		<a href="<?= base_url('citas/editar/' . $cita['PK_ID_CITA']) ?>" class="btn btn-warning btn-sm w-100">Editar</a>
																	</div>

																	<!-- Mostrar "Eliminar" solo si la cita NO está dada de baja -->
																	<?php if (!$cita['FECHA_BAJA']): ?>
																	<div class="menu-item px-3">
																		<a href="<?= base_url('citas/eliminar/' . esc($cita['PK_ID_CITA'])) ?>" class="btn btn-danger btn-sm w-100"
																			onclick="return confirm('¿Estás seguro de eliminar esta cita?');">Eliminar</a>
																	</div>
																	<?php endif; ?>

																	<!-- Mostrar "Dar de Alta" solo si la cita está dada de baja -->
																	<?php if ($cita['FECHA_BAJA']): ?>
																	<div class="menu-item px-3">
											...
											<div class="mt-4">
												<?= $pager->only(['FECHA', 'DIAGNOSTICO', 'TRATAMIENTO'])->links('default', 'custom_pagination') ?>
											</div>
