											...
											<div class="card-body">
                                                    ...
                                                    <div class="d-flex flex-center flex-column py-5">
														...
														<div class="card shadow-sm border-0 rounded-3 p-4" style="width: 100%; max-width: 500px;">
															<div class="card-body">
																<form id="formMascota" action="<?= base_url($mascota ? 'mascotas/editar/' . $mascota['PK_ID_MASCOTA'] : 'mascotas/guardar') ?>" method="post">
																	<?= csrf_field(); ?>
																	...
																	<div class="mb-3">
																		<label for="ESPECIE" class="form-label required">Especie</label>
																		<input type="text" name="ESPECIE" id="ESPECIE" class="form-control" 
																			value="<?= old('ESPECIE', esc($mascota['ESPECIE'] ?? '')) ?>" required>
																	</div>

																	<div class="mb-3">
																		<label for="RAZA" class="form-label required">Raza</label>
...
document.addEventListener("DOMContentLoaded", function () { 
    ...
    formMascota.addEventListener("submit", function () {
        btnGuardar.disabled = true;  // Desactivar botón al enviar formulario
    });
});
</script>
